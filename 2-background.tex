...
sparsely update $\W{e}$. For more advanced architectures, such as multi-layer
...
a ``vertical'' one from  the loss and a ``recurrent'' one from the timestep
$t+1$ which was set in Line 8.
