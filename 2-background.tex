...
simply view NMT as a source-conditioned language model. To understand how NMT systems work, we
...
language modeling and RNN, we have discussed NMT in detail from training to testing.}
