%I first give a brief overview of Neural Machine Translation before describing
%the model architecture of interest, the deep multi-layer recurrent model with
%LSTM. I then explain the different types of NMT weights
%together with my approaches to pruning and retraining.
%
